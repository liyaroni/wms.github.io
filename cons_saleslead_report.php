...
<title>Report:Sales Lead For Consumer Cards</title>
...
<tr><td colspan=2 align=center><b><i>::Cons. Sales lead::<i></b></td></tr> 
...
<table class='table' border='1' style='border-collapse: collapse' cellspacing='1' align="center" width="100%" bordercolor="red">

  <td bgcolor='#CCFFCC' colspan=10 align=center><b><i>Sales Lead For Asset/Liabilities/Cards(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	
	<td width="12%"><b><i>Applicant Name</b></i></td>	
	<td width="11%"><b><i>Contact Number</b></i></td>
	<td width="10%"><b><i>Profession</b></i></td>
	<td width="10%"><b><i>Interested for</b></i></td>
	<td width="20%"><b><i>Address</b></i></td>
	<td width="10%"><b><i>District</b></i></td>
	<td width="13%"><b><i>Remarks</b></i></td>
	<td width="7%"><b><i>Date</b></i></td>
	<td width="5%"><b><i>Time</b></i></td>
	<td width="8%"><b><i>User</b></i></td>
</tr>	
	

<?php
$sql    = 'SELECT * FROM cons_sales WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") ORDER BY date,time DESC';
