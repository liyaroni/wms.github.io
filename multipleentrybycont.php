...
<title>Multiple WorkCode By Cont#</title>
...
<tr><td colspan=2 align=center><b><i>::Multiple WorkCode By Cont#::</i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=4 align=center><b><i>Multiple WorkCode By Cont #(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	<td align="left" width="20%"><b><i>Contact Number</i></b></td>
...
<?php
$sql    = 'SELECT contactnumber,user,count(*) as hitcount FROM servicedetail WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") GROUP BY contactnumber,user ORDER BY hitcount DESC';
