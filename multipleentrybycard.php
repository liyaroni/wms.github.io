...
<title>Multiple Work Code By Card#</title>
...
<tr><td colspan=2 align=center><b><i>::Multiple WorkCode By Card & A/C#::</i></b></td></tr> 
...
<table class='table' border='1' style='border-collapse: collapse' cellspacing='1' align="center" width="60%" bordercolor="red">

<td bgcolor='#CCFFCC' colspan=4 align=center><b><i>Multiple Work Code By Card & A/C# (From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	<td align="left" width="20%"><b><i>Card & A/C Number</i></b></td>
	<td align="left" width="20%"><b><i>User</b></i></td>
	<td align="left" width="20%"><b><i>Count</b></i></td>
</tr>	
	

<?php
$sql    = 'SELECT cardnumber,user,count(*) as hitcount FROM servicedetail WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") GROUP BY cardnumber,user ORDER BY hitcount DESC';
