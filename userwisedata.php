...
<title>User Wise Work Code</title>
...
<tr><td colspan=2 align=center><b><i>::User wise work code::</i></b></td></tr> 
...
<tr>
<td>WMS Id</td>
<td><input type="text" name="wcode" value=""size="20" ></td>
</tr>
...
<td bgcolor='#CCFFCC' colspan=8 align=center><b><i>User Wise Work Code (From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>
...
<tr bgcolor='#CCFFCC'>
	...
	<td width="20%"><b><i>Branch Name</b></i></td>
	<td width="20%"><b><i>Account & Card Type</b></i></td>
	<td width="20%"><b><i>Remarks</b></i></td>
	<td width="4%"><b><i>Type</b></i></td>
...
<?php
$sql    = 'SELECT *,query.workcode as "work-code",query.subcategory as query FROM servicedetail,query WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND (servicedetail.user="'.$_REQUEST["wcode"].'") AND query.workCode=servicedetail.workCode ';
