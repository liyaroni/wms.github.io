...
function empty()
{
    ...
    {
        window.alert('No contact number specified for searching')
...
<table class="menu" width="40%" border="1" cellspacing="1" cellpadding="1" align="center">
	...
	<tr>
		...
		<td width="40%" align="center"><b>Contact Number</b></td>     
...
<td bgcolor="#CCFFCC" colspan=9 align="center"><b><i>History(Contact # <?php echo $card;?>)</i></b></td>

<tr bgcolor="#CCFFCC">
	
	<td align="left" width="8%"><b><i>Card & A/C Number</b></i></td>
	<td align="left" width="8%"><b><i>Contact Number</b></i></td>
	<td align="left" width="12%"><b><i>Category</b></i></td>
	<td align="left" width="12%"><b><i>Query</b></i></td>
	<td align="left" width="15%"><b><i>Branch Name</b></i></td>
	<td align="left" width="15%"><b><i>Account & Card Type</b></i></td>
	<td align="left" width="25%"><b><i>Remarks</b></i></td>
	<td align="left" width="6%"><b><i>Work Code</b></i></td>
	<td align="left" width="6%"><b><i>Type</b></i></td>
	<td align="left" width="7%"><b><i>Date</b></i></td>
	<td align="left" width="8%"><b><i>Time</b></i></td>
	<td align="left" width="8%"><b><i>User</b></i></td>
	

<?php
$sql    = 'SELECT  *,query.workcode as "work-code",query.category as category,query.subcategory as query,servicetype.name as name,servicetype.name as name FROM servicedetail,query,servicetype WHERE contactnumber="'.$_REQUEST["search1"].'" AND query.workCode=serviceDetail.workCode AND servicetype.stype=serviceDetail.stype ORDER BY date DESC';
