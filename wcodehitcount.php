...
<tr><td colspan=2 align=center><b><i>::Work code count::</i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=4 align=center><b><i>Work Code Count(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>
...
<?php
$sql    = 'SELECT *,query.category as cat,query.subcategory as query,count(servicedetail.workcode) as totalhit FROM servicedetail,query WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND query.workCode=serviceDetail.workCode GROUP BY servicedetail.workCode ORDER BY totalhit DESC';;
