...
<tr bgcolor='#CCFFCC'>
	...
	<td width="15%"><b><i>Branch Name</b></i></td>
	<td width="15%"><b><i>Account & Card Type</b></i></td>
...
<?php
$sql    = 'SELECT *,query.workcode as "work-code",query.subcategory as query FROM servicedetail,query WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND query.workCode=serviceDetail.workCode ';
