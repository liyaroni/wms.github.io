...
<title>Frequent Caller Report</title>
...
<tr><td colspan=2 align=center><b><i>::Frequent Caller Report::</i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=4 align=center><b><i>Frequent Caller Report(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>
...
<?php
$sql    = 'SELECT contactnumber,count(contactnumber) as hitcount FROM servicedetail WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") GROUP BY contactnumber ORDER BY hitcount DESC';
