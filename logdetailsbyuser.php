...
<title>Log Details By User</title>
...
function empty()
{
    if ( document.searchd.username.value == '' )
    {
        window.alert('USER NAME ? ?')
        document.searchd.username.focus();
	return false;
    }
...
<td width="12%" align="center"><b>User Name</b></td>
<td width="25%"><input type="text" name="username" size="15"></td>
...
<tr>
	...
	<td bgcolor='#00CCFF' align="center" width="7%">Card Type</td>
	...
	<td bgcolor='#00CCFF' align="center" width="23%">Call Remarks</td>
	<td bgcolor='#00CCFF' align="center" width="25%">Notes</td>

<?php
$sql    = 'SELECT  * FROM servicedetails WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND (user="'.$_REQUEST["username"].'") ORDER BY date';
