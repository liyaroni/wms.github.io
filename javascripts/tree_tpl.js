...
var TREE_TPL = {
	...
	'icon_48' : 'icons/folder1.gif',   // root icon normal
	'icon_52' : 'icons/foldersel.gif',   // root icon selected
	'icon_56' : 'icons/folder1.gif',   // root icon opened
	'icon_60' : 'icons/foldersel.gif',   // root icon selected
	
	'icon_16' : 'icons/folder1.gif', // node icon normal
	'icon_20' : 'icons/foldersel.gif', // node icon selected
	'icon_24' : 'icons/foldersel.gif', // node icon opened
