...
<title>Work Code Wise Data</title>
...
<tr><td colspan=2 align=center><b><i>::Work code wise data::</i></b></td></tr> 
...
<tr>
<td>Work Code</td>
<td><input type="text" name="wcode" value=""size="8" maxlength='4'></td>
</tr>
...
<td bgcolor='#CCFFCC' colspan=8 align=center><b><i>Work Code Wise Data (From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>
...
<?php
$sql    = 'SELECT *,query.workcode as "work-code",query.subcategory as query FROM db_wms_archive,query WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND (db_wms_archive.workcode="'.$_REQUEST["wcode"].'") AND query.workCode=db_wms_archive.workCode ';
