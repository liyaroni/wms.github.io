...
<title>Date Wise Work Code</title>
...
<tr><td colspan=2 align=center><b><i>::Date wise work code::</i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=3 align=center><b><i>Date Wise Work Code(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	<td align="left" width="25%"><b><i>Date</i></b></td>
	<td align="left" width="25%"><b><i>Number of work code</b></i></td>	
</tr>	
	

<?php
$sql    = 'SELECT date,count(date) as count FROM servicedetail WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") GROUP BY date';
