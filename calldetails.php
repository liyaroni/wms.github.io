...
<title>Service Log details</title>
...
<tr><td colspan=2 align=center><b><i>::Out Bound Service Log::</i></b></td></tr> 
...
<table class='report' border='1' style='border-collapse: collapse' cellspacing='1' align="center" width="100%" bordercolor="#0099CC">

<td bgcolor='#0099CC' colspan=9 align=center><b>Out Bound Service Log Details(From <?php echo $sdate;?> To <?php echo $edate;?>)</b></td>

<tr bgcolor='#0099CC'>
	<td align="left" width="7%"><b><i>Card & A/C Number</i></b></td>
	<td align="left" width="8%"><b><i>Contact Number</b></i></td>
	<td align="left" width="7%"><b><i>Card & A/C Type</b></i></td>
	<td align="left" width="14%"><b><i>Call Category</i></b></td>
	<td align="left" width="6%"><b><i>Call Status</b></i></td>
	<td align="left" width="22%"><b><i>Call Remarks</b></i></td>
	<td align="left" width="25%"><b><i>Notes</b></i></td>
	<td align="left" width="5%"><b><i>Date</b></i></td>
	<td align="left" width="5%"><b><i>Time</b></i></td>
...
<?php
$sql    = 'SELECT  * FROM servicedetails WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND (user="'.$_SESSION["user_name"].'") ORDER BY date';
