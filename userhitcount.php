...
<title>User Work Code Count</title>
...
<tr><td colspan=2 align=center><b><i>::User work code count::</i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=2 align=center><b><i>User Work Code Count(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	
	<td align="left" width="25%"><b><i>User</b></i></td>
	<td align="left" width="25%"><b><i>Count</b></i></td>
</tr>	
	

<?php
$sql    = 'SELECT user,time,count(user) as hitcount FROM servicedetail WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") GROUP BY user ORDER BY hitcount DESC';
