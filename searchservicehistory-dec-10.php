...
<table class="menu" width="40%" border="1" cellspacing="1" cellpadding="1" align="center">
	...
	<tr>
		...
		<td width="40%" align="center"><b>Card Number</b></td>     
...
<td bgcolor="#CCFFCC" colspan=9 align="center"><b><i>History(Card # <?php echo $card;?>)</i></b></td>
...
<?php
$sql    = 'SELECT  *,query.workcode as "work-code",query.category as category,query.subcategory as query,servicetype.name as name,servicetype.name as name FROM db_wms_archive,query,servicetype WHERE cardnumber="'.$_REQUEST["search1"].'" AND query.workCode=db_wms_archive.workCode AND servicetype.stype=db_wms_archive.stype ORDER BY date DESC';
