...
<tr><td colspan=2 align=center><b><i>::Top twenty work code::</i></b></td></tr> 
...
<table class='table' border='1' style='border-collapse: collapse' cellspacing='1' align="center" width="80%" bordercolor="red">

<td bgcolor='#CCFFCC' colspan=4 align=center><b><i>Top Twenty work code(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	
	<td align="left" width="10%"><b><i>Work Code</b></i></td>
	<td align="left" width="20%"><b><i>Category</b></i></td>	
	<td align="left" width="40%"><b><i>Query</b></i></td>
	<td align="left" width="12%"><b><i>Count</b></i></td>
...
<?php
$sql    = 'SELECT *,query.category as cat,query.subcategory as query,count(servicedetail.workcode) as totalhit FROM servicedetail,query WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") AND query.workCode=serviceDetail.workCode GROUP BY servicedetail.workCode ORDER BY totalhit DESC LIMIT 0, 20';;
