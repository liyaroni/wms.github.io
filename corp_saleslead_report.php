...
<title>Report:Sales Lead For Corporate Cards</title>
...
<tr><td colspan=2 align=center><b><i>::Corp.Cards Sales lead::<i></b></td></tr> 
...
<td bgcolor='#CCFFCC' colspan=10 align=center><b><i>Sales Lead For Corporate Cards(From <?php echo $sdate;?> To <?php echo $edate;?>)</i></b></td>

<tr bgcolor='#CCFFCC'>
	
	<td width="18%"><b><i>Organization Name</b></i></td>	
	<td width="12%"><b><i>Contact Person</b></i></td>
	<td width="9%"><b><i>Designation</b></i></td>
	<td width="15%"><b><i>Contact Number</b></i></td>
	<td width="20%"><b><i>Address</b></i></td>
	<td width="8%"><b><i>City</b></i></td>
	<td width="10%"><b><i>Remarks</b></i></td>
...
<?php
$sql    = 'SELECT * FROM corp_sales WHERE (`date` between "'.$_REQUEST["searchstart"].'" AND "'.$_REQUEST["searchend"].'") ORDER BY date,time DESC';
